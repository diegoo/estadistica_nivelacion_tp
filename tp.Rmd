...
```{r, results='markup'}
par(mfrow=c(1,3))
boxplot(subset(abulones, Sex == 'F')$Height, main = "femenino")
boxplot(subset(abulones, Sex == 'M')$Height, main = "masculino")
boxplot(subset(abulones, Sex == 'I')$Height, main = "juvenil")
```
#

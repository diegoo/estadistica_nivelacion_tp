...
Dimensiones y crecimiento de los mejillones
===========================================

# Propósito

```
Aplicar herraimientas de estadística descriptiva & de inferencia para analizar un data set.
```
...
```{r, results='markup'}
nombres <- c('sex','length','diameter','height','weight.w','weight.s','weight.v','weight.sh','rings')
dataset <- read.csv("data/dataset.csv")
names(dataset) <- nombres
```
